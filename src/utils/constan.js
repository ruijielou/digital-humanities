...
export default {
    getConstOpts,getConstName,commonConstant, BooleanConstant, SystemConstant, get_time_until_now,get_time_interval, format_date
    , AuthType, DhcRepositoryStatus,DhuUserStatus,DhuUserAuthStatus,format_id,DhuFavoriteType ,CreateType
    ,DhcMetaEntityDataType ,DhcMetaEntitySubType, DhcMetaStatus, DhcCaseStatus, MetaGroupConstant
}
/**
 * 获取常量作为选项的设置
 */
